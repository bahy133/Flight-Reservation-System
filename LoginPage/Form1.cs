...
namespace LoginPage
{
    public partial class Form1 : Form
    {
        ...
        {
           // int ddd =Convert.ToInt32( global.passuser);
            con.Open();
            OracleCommand comm = new OracleCommand();
            comm.Connection = con;
            comm.CommandText = "GetID";
            comm.CommandType = CommandType.StoredProcedure;
            comm.Parameters.Add("fname", global.par);
            comm.Parameters.Add("ssnid", OracleDbType.Int32).Direction=ParameterDirection.Output;
            comm.ExecuteNonQuery();
            textBox2.Text = comm.Parameters["ssnid"].Value.ToString();
